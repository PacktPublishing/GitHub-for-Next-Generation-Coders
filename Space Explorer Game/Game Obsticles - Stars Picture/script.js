...
alienImage.src = "alien.png"; // Path to your alien image
const asteroidImage = new Image();
asteroidImage.src = "asteroid.png"; // Path to your asteroid image
...
starImage.src = "star.png"; // Path to your star image
...
projectileImage.src = "projectile.png"; // Replace with the path to your image
...
function createObstacle() {
  ...
  obstacles.push({ x, y, width: obstacleWidth, height: obstacleHeight, type });
}
