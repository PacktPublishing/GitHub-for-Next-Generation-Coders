...
function createStar() {
  ...
  starElement.innerHTML = '<i class="fas fa-star"></i>'; // FontAwesome star icon
  starElement.className = "star"; // CSS class for styling
  starElement.style.left = x + "px";
  starElement.style.top = y + "px";
  document.getElementById("gameCanvas").appendChild(starElement);
  stars.push({ x, y, radius: starRadius });
  stars.push({ element: starElement, x, y });
}
